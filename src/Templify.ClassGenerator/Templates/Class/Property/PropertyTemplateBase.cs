...
{
    public abstract class PropertyTemplateBase<TPropertyTemplate> : TemplateBase<TPropertyTemplate>, IPropertyTemplate
        where TPropertyTemplate : TemplateBase<TPropertyTemplate>
    {
